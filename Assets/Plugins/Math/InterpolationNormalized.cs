...
{    
    ...
    // https://www.wolframalpha.com/input/?i=Plot%5Bt,+0..1%5D
    ...
    {
        return InterpolationNormalized.DoEaseInOut(t,
                                                   InterpolationNormalized.QuadraticIn,
                                                   InterpolationNormalized.QuadraticOut);
    }
    ...
    // https://www.wolframalpha.com/input/?i=Plot%5B(t-1)%5E3+%2B+1,+0..1%5D
    ...
    {
        return InterpolationNormalized.DoEaseInOut(t, 
                                                   InterpolationNormalized.CubicIn,
                                                   InterpolationNormalized.CubicOut);
    }

    // https://www.wolframalpha.com/input/?i=Plot%5B1+-+sqrt(1+-+t+*+t),+0..1%5D
    public static float CircularIn(float t)
    { 
        return 1f - Mathf.Sqrt(1f - t * t);
    }

    // https://www.wolframalpha.com/input/?i=Plot%5Bsqrt((2+-+t)+*+t),+0..1%5D
    ...
    {
        return InterpolationNormalized.DoEaseInOut(t,
                                                   InterpolationNormalized.CircularIn,
                                                   InterpolationNormalized.CircularOut);
    }
    ...
    {
        return InterpolationNormalized.DoEaseInOut(t,
                                                   InterpolationNormalized.BounceEaseIn,
                                                   InterpolationNormalized.BounceEaseOut);
    }

    // https://www.wolframalpha.com/input/?i=Plot%5Bsin(t*PI),+0..1%5D
    ...
    // https://www.wolframalpha.com/input/?i=Plot%5B(t+*+2)+mod+1,+0..1%5D
